...
一个基于 Vue 3 + TypeScript 构建的在线简历填写与生成工具。无需注册，打开即用，支持可视化编辑、主题切换、模块排序、主题色自定义、多语言内容、JSON 导入导出，以及浏览器原生 PDF 打印导出。
...
|                    简约纸张                    |                     科研保研                      |                     标题背景色                      |
| :--------------------------------------------: | :-----------------------------------------------: | :-------------------------------------------------: |
| ![简约纸张](./public/images/minimal-paper.png) | ![科研保研](./public/images/research-scholar.png) | ![标题背景色](./public/images/cv-with-title-bg.png) |
